...
export const projects: Project[] = [
  {
    ...
    details: "Built to make product availability and stock records easier to review from one place.",
  ...
  },
  {
    ...
    details: "A practical workflow for keeping financial information, documents, and routine office work organised.",
  ...
  },
  {
    ...
    details: "Designed around everyday transaction handling, so sales and stock information stay connected.",
  ...
  
  {
    ...
    details: "Focused on a clear data foundation for applications and the business information they support.",
